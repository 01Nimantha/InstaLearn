    ...
    try {
      ...
      if (error.response) {
        if (error.response.status === 400) {
          ...
          alert("Attendance for this student has already been recorded for this class.");
        } else {
  ...
  return (
    ...
    classTypeInfo
        ...
        <div className="flex flex-col lg:flex-row gap-3 flex-1 min-h-0">
          {/* QR Scanner Card with fun animations */}
          ...
          {/* Student Info Card with animations */}
          <div className="w-full lg:w-1/2 bg-white/90 backdrop-blur rounded-xl shadow-lg overflow-hidden flex flex-col transform hover:scale-[1.01] transition-all duration-300">
            ...
            <div className="p-3 flex-1 overflow-y-auto">
              ...
              <div className="flex justify-center mb-3">
                <div className="relative group">
                  <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg bg-gray-100 flex items-center justify-center transform transition-transform group-hover:scale-110 duration-300">
                    {student.studentId ? (
                      <img
                        src={student.image?.imageId ? `http://localhost:8085/api/v1/image/get-image/${student.image.imageId}` : "https://th.bing.com/th/id/OIP.ZMB81W_uLDsEIxaMWxDljAHaHa?rs=1&pid=ImgDetMain"}
                        alt="Profile"
              ...
              <div className="space-y-3">
                ...
                <div className="transform transition-all duration-300 hover:scale-[1.02]">
                  <label className="block text-gray-600 text-xs font-medium mb-1">Payment Status</label>
                  <select className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-700 appearance-none focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent hover:border-green-500 transition-colors">
