    ...
    <div className='flex'>
      <div>  
        <Sidebar 
          ...
          Tab1functions="/"
          Tab2="Students" 
          Tab2Icon={PiStudentFill} 
          Tab2functions='/students'
          Tab3="Manage Schedule" 
          Tab3Icon={HiCalendarDateRange} 
          Tab3functions="/" 
          Tab4="Payments" 
          Tab4Icon={MdOutlinePayment} 
          Tab4functions="/payment"
          Tab5="Attendance" 
          Tab5Icon={FaRegCalendarCheck} 
          Tab5functions="/"
          AddNewTab={true} 
          Tab6="Settings" 
          Tab6Icon={IoIosSettings} 
          Tab6functions="/"
        />
      </div>
